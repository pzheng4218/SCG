...
G = (w_ref - np.sign(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) * gmax(
        (np.abs(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) - 0.5 * lam1), 0)) / 0.5
D1.append(w_ref)
SS1.append(sarah.difference_logistic_function(w_ref) - star)
...
G = (w_ref - np.sign(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) * gmax(
        (np.abs(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) - 0.5 * lam1), 0)) / 0.5
D2.append(w_ref)
SS2.append(sarah.difference_logistic_function(w_ref) - star)
...
eta = 2 / (4 + L * gamma)
C1 = 2 / (3 * L ** 2 * gamma ** 2)
size_b = max(math.floor(n ** (1 / 3) / C1), 1)
...
G = (w_ref - np.sign(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) * gmax(
        (np.abs(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) - 0.5 * lam1), 0)) / 0.5
D3.append(w_ref)
SS3.append(sarah.difference_logistic_function(w_ref) - star)
...
G = (w_ref - np.sign(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) * gmax(
        (np.abs(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) - 0.5 * lam1), 0)) / 0.5
D5.append(w_ref)
SS5.append(sarah.difference_logistic_function(w_ref) - star)
...
G = (w_ref - np.sign(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) * gmax(
        (np.abs(w_ref - 0.5 * sarah.difference_logistic_grad(w_ref)) - 0.5 * lam1), 0)) / 0.5
D6.append(w_ref)
SS6.append(sarah.difference_logistic_function(w_ref) - star)
