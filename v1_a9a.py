...
plt.xticks(range(0, outer_epoch * (inner_loop+1) + 1, 10))
# plt.yticks([0, 1])
line1, = plt.plot(pass1, S1, linestyle='--', linewidth=1.5, color='brown', label=r'Acc-Prox-CG-SARAH')
line3, = plt.plot(pass2, S2, linestyle='--', linewidth=1.5, color='lightpink', label=r'Acc-Prox-CG-SARAH-RS')
line4 = plt.scatter(pass3, S3, s=15, color='blue', label=r'Acc-Prox-CG-SARAH-ST')
line9, = plt.plot(pass1, S9, linestyle='-', linewidth=2, color='green', label=r'Bound')
font1 = {'size': 7}
plt.legend(handles=[line1, line3, line4, line9], prop=font1)
plt.show()
